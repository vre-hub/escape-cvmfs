...
#!   09Jul25: E. Garcia: Adapt for Rucio Jupyterlab extension
#!
#!----------------------------------------------------------------------------

# Minimal setup for Rucio client and jupyterlab extensions environment
...
export PYTHONPATH="$PYTHONPATH:$sitepkgs" # Order within PYTHONPATH is relevant, don't change it.
