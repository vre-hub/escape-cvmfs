...
# Usage:
#   ./reana-cvmfs-updater.sh [-f|--force] <GITHUB_TOKEN> <ARTIFACT_ID> [REANA_VERSION]
#
# Options:
#   -f, --force    Replace existing folder if it exists
#
# or set environment variables:
#   TOKEN=... ID=... REANA_VERSION=... ./reana-cvmfs-updater.sh
...
echo "Done. REANA client $REANA_VERSION deployed to $MOUNTPOINT/$TARGET_DIR"
